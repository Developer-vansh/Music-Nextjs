  ...
  return (
    ...
    <div>
        ...
        <p className="mt-2 text-3xl leading-8 font-extrabold
         tracking-tighter text-white sm:text:4xl">Learn With the Best</p>
        </div>
    </div>  
     <div className="mt-10">
      <div className="grid grid-cols-1 sm:grid-cols-2
       ...
       <BackgroundGradient className="flex flex-col rounded-[22px] max-w-sm overflow-hidden h-full bg-white dark:bg-zinc-900">
        <div className="p-4 sm:p-6 flex flex-col items-center text-center flex-grow">
            ...
            <p className="text-sm text-neutral-400 dark:text-neutral-400 flex-grow">{course.description}</p>
     ...
     <div className="mt-20 text-center"> 
        <Link className="bg-slate-500 p-4 rounded" href="/courses">
        View All courses
        </Link>
        </div>   
    </div>
